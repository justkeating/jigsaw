...
public class GameBoardView extends RelativeLayout implements OnTouchListener {
	...
	public static final int GRID_SIZE = 2; // 3X3
	...
	public void fillTiles() {
		...
		original= = Bitmap.createScaledBitmap(original, original.getHeight(), original.getHeight(), false);
...
//		masterOriginal=original;
//		if (masterOrinal = original)
//		{
